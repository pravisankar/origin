...
// Allocate attempts to allocate the item both locally and in etcd.
...
// AllocateNext attempts to allocate the next item both locally and in etcd.
...
// Release attempts to release the provided item both locally and in etcd.
