...
func newStorage(t *testing.T) (*Etcd, *tools.FakeEtcdClient, allocator.Interface) {
	...
	etcd := NewEtcd(mem, "/ranges/namespacevnids", api.Resource("namespacevnidallocation"), etcdStorage)
...
func TestStore(t *testing.T) {
	...
	other = allocator.NewAllocationMap(100, "rangeSpecValue")
	otherStorage := NewEtcd(other, "/ranges/namespacevnids", api.Resource("namespacevnidallocation"), storage.storage)
