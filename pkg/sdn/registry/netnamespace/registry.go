...
type Registry interface {
	...
	ListNetNamespaces(ctx kapi.Context, options *kapi.ListOptions) (*api.NetNamespaceList, error)
	...
	WatchNetNamespaces(ctx kapi.Context, options *kapi.ListOptions) (watch.Interface, error)
}
...
func (s *storage) ListNetNamespaces(ctx kapi.Context, options *kapi.ListOptions) (*api.NetNamespaceList, error) {
...
func (s *storage) WatchNetNamespaces(ctx kapi.Context, options *kapi.ListOptions) (watch.Interface, error) {
