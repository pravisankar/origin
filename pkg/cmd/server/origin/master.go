...
func (c *MasterConfig) GetRestStorage() map[string]rest.Storage {
	...
	if c.MultitenantNetworkConfig != nil {
		storage["netNamespaces"] = netnamespace.NewStorage(c.MultitenantNetworkConfig.NetNamespaceRegistry, c.MultitenantNetworkConfig.NetIDAllocator, []string{"default"})
	}
